...
<script>
var Keyboard = require("../assets/js/engine.js");
var FastProvince = require("../assets/js/provinces.js");
...
module.exports = {
  ...
  components: {
    "number-view": require("./keyBoard/NumberView.vue"),
    "keyboard-view": require("./keyBoard/KeyboardView.vue")
  },
}
